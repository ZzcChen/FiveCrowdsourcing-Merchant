...
public class SendingOrderPresenter {
    ...
    private void parseJSONWithJONObject(String jsonData) {
        ...
        sendingOrderFragment.dispalyOrder(list);
    }
}
