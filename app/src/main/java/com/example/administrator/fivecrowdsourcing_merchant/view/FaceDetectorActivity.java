 ...
 */
public class FaceDetectorActivity extends Activity implements  CenterDialog.OnCenterItemClickListener{
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mDetectorData != null) {
                mFace_detector_distance.setText(String.valueOf(mDetectorData.getLightIntensity()));
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vise_face);
        mContext = this;
        init();
    }
...
//        display.getRealSize(mContext);
//        height = ;
        float scale = (float) bitmap.getHeight() / getScreenHeight(mContext);
        if (rect.right > 0) {
