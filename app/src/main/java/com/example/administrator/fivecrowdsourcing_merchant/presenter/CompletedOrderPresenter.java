...
public class CompletedOrderPresenter {
    ...
    private String initservletName="DispalyCompetedServlet";
    private String servletIP;
    private List<DeliveryOrder> list = new ArrayList<DeliveryOrder>();

    public CompletedOrderPresenter(CompletedOrderFragment completedOrderFragment) {
    ...
    private void parseJSONWithJONObject(String jsonData) {
       ...
       completedOrderFragment.dispalyOrder(list);
    }
}
